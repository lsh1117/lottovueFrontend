...
/**
 * 회원 분석번호 저장
 * @param {Object} recommendation - 분석번호 데이터 { drw_no, no1, no2, no3, no4, no5, no6 }
 * @returns {Promise} 저장된 분석번호 정보
 */
...
/**
 * 특정 분석번호 조회
 * @param {number} recommendation_id - 분석번호 ID
 * @returns {Promise} 분석번호 정보
 */
 ...
 * 회원 분석번호 수정
 * @param {number} recommendation_id - 분석번호 ID
 * @param {Object} recommendation - 수정할 분석번호 데이터
 * @returns {Promise} 수정된 분석번호 정보
 */
